...
cdef extern from "mmultfile.h":
    int _mmultfile_b_less_aatbx "mmultfile_b_less_aatbx"(char* a_filename, long long row_count, long long a_col_count, long long b_col_count, double* b1, double* aaTb, double* aTb, int num_threads, long long log_frequency)
    int _mmultfile_atax "mmultfile_atax"(char* a_filename, long long row_count, long long col_count, long long work_index, long long work_count, double* ata_piece, int num_threads, long long log_frequency)
