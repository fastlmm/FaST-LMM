...
if __name__ == '__main__':
    ...
    for m_row in  [6, 1, 2, 4,10,4*1000]:#[6,50000,100000]: #300,500,1000,2000,4000,6000,9000,15000]:# [6, 1, 2, 4,10,500]:#,15000,20000,50000]: #50000,500,100000,15000,9000,2000]:#
