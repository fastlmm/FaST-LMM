...
def heritability_spatial_correction(G_kernel, spatial_coor, spatial_iid, alpha_list, alpha_power, pheno, 
    ...
    :type G_kernel: a `KernelReader <http://microsoftgenomics.github.io/PySnpTools/#kernelreader-kernelreader>`_, `SnpReader <http://microsoftgenomics.github.io/PySnpTools/#snpreader-snpreader>`_ or a string
    ...
    :param pheno: The target values(s) to predict. It can be a file name readable via `Pheno <http://microsoftgenomics.github.io/PySnpTools/#snpreader-pheno>`_ or any `SnpReader <http://microsoftgenomics.github.io/PySnpTools/#snpreader-snpreader>`_.
    :type pheno: a `SnpReader <http://microsoftgenomics.github.io/PySnpTools/#snpreader-snpreader>`_ or string
