...
* [Join](mailto:fastlmm-user-join@python.org?subject=Subscribe) the user discussion and announcement list (or [web sign up](https://mail.python.org/mailman3/lists/fastlmm-user.python.org)).
